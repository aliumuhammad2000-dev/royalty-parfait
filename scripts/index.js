...
import { renderCart, calculateCartTotal } from "./checkout.js";
    ...
    <div class="card">
      ...
      <div class="flex flex-col grow p-5 text-center">
        ...
        <div class="mt-auto pt-6">
          ...
          <button class="add-to-cart-btn text-sm bg-gray-600 px-3 py-1.5 text-white rounded-full mt-4 cursor-pointer transition ease-in-out duration-300 hover:bg-gray-700" data-product-id="${product.id}">Add to Cart</button>
        </div>
      </div>
    </div>
    `
